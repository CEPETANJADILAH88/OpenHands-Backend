...
# Conditional imports for external services and Docker
try:
    from openhands.runtime.impl.docker.docker_runtime import DockerRuntime
    DOCKER_AVAILABLE = True
except ImportError:
    # Fallback when docker package is not available (HF Spaces doesn't support Docker)
    class DockerRuntime:
        def __init__(self, *args, **kwargs):
            raise ImportError("DockerRuntime requires docker package (not available in HF Spaces)")
